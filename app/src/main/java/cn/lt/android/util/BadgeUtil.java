...
public class BadgeUtil {
    ...
    public static void setBadgeCount(Context context, int count) {
        ...
        LogUtils.i("BadgeCounter", "支持的机型" + Build.MANUFACTURER);
...
//        } else {
//            Toast.makeText(context, "角标不支持的机型" + Build.MANUFACTURER, Toast.LENGTH_LONG).show();
//        }
    }
    ...
    public static void setBadgeOfHuawei(Context context, int count) {
        String launcherClassName = getLauncherClassName(context);
