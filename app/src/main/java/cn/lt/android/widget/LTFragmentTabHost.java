 ...
 * complete}
 */
public class LTFragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public LTFragmentTabHost(Context context) {
    ...
    public LTFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onAttachedToWindow() {
        ...
        if (ft != null) {
            ft.commitAllowingStateLoss();//容Bugly错
