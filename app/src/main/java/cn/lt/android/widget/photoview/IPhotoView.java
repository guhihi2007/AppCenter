...
public interface IPhotoView {
    ...
    /**
     * Register a onEvent to be invoked when the Photo displayed by this view is long-pressed.
     *
    ...
    /**
     * Register a onEvent to be invoked when the Matrix has changed for this View. An example would
    ...
    /**
     * Register a onEvent to be invoked when the Photo displayed by this View is tapped with a
     * single tap.
     *
     * @param listener - Listener to be registered.
     */
    ...
    /**
     * Register a onEvent to be invoked when the View is tapped with a single tap.
     *
     * @param listener - Listener to be registered.
     */
    ...
    /**
     * Returns a onEvent listener to be invoked when the View is tapped with a single tap.
     *
