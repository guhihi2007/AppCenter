...
//        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CirclePageIndicator, defStyle, 0);
        ...
        mDivider = a.getDimensionPixelSize(R.styleable.CirclePageIndicator_spacing,0);
        defaultFillColor = a.getColor(R.styleable.CirclePageIndicator_selectedColor, defaultFillColor);
        defaultPageColor = a.getColor(R.styleable.CirclePageIndicator_unSelectedColor, defaultPageColor);
...
//        final float threeRadius = mRadius * 3;
        final float threeRadius = mRadius * 3+mDivider;
     ...
     * @param isLoop
     */
    public void setScrollLoop(boolean isLoop) {
        this.isLoop = isLoop;
    }
